# FABLE — Engine Schema (v7)

*The irreducible mechanical specification, fused with the design philosophy it enforces. FABLE is built around restraint: every surface has one job, every promise has a mechanical enforcement point, and every rule must produce meaningful play, reduce ambiguity, or support the intended experience. Examples, teaching, and calibration live in the Starter Kit — this document is the spec.*

---

## 0. Design Claim

FABLE is a game about **competent characters navigating dangerous situations.** Its central concern is not whether skilled people can perform basic tasks, but what **risk, cost, consequence, and change** follow from decisive action.
...
1. **Competence is the baseline.** Skilled characters are reliable in their areas of expertise; rolls determine cleanliness, cost, complication, and change.
2. **Preparation should matter.** Research, leverage, position, timing, access, and social advantage can reduce risk, increase effect, open possibility, expose weakness, or remove reducible uncertainty.
3. **Cause and effect should be legible.** Fictional advantages convert through named mechanical surfaces, not hidden GM preference.
4. **The system pressures circumstances, not interiority.** Rules may change body, resources, reputation, relationships, options, access, position, danger, obligation, and strain. They do not author what a player character believes, feels, values, or chooses inside.
5. **Relationships are part of the tactical field.** People, debts, favors, obligations, loyalties, and reputation create leverage, pressure, access, vulnerability, and consequence.
6. **Complexity should be restrained.** The engine uses a small set of recurring primitives rather than isolated subsystems.
7. **Advancement is primarily positional.** Mechanical growth is gradual; major growth comes from alliances, secrets, favors, status, territory, access, reputation, and unresolved obligations.
8. **Design claims should be explicit.** Claims about the engine should be marked as mathematically checked, simulated, reasoned, playtest-confirmed, or still awaiting table confirmation.
...
> **Restraint.** A rule is valuable only if it produces meaningful play, reduces ambiguity, or supports the intended experience. The aim is not maximum complexity, but a compact structure that can be trusted, tested, and used flexibly.
...
|---|---|---|
| Competence is reliable | 3d6 curve · skill scale · no empty rolls · cost-forward results | drama-by-whiffing |
| Rolls decide cost and change, not embarrassment | result bands · Exposure · Effect · Record step | competent characters looking foolish for no fictional reason |
| Preparation matters | Ledger · Truths · Prep Rounds · Top Exit | cleverness paying only at GM whim |
| Preparation is not deterministic | Exit Check · Simple/Complex obstacles · clocks · Fronts · maintained Truths | the scene solved before it begins |
| Cause and effect are legible | named Ledger payouts · fixed pre-roll stakes · surface invariants | players guessing at hidden judgment |
| Danger is not difficulty | TN / Exposure split | inflating TN to express threat |
| Tension survives competence | Exposure · Effect limits · clocks · Fronts · Seams · world motion | a tensionless clean-success treadmill |
| Consequences persist | Truths · Scars · clocks landing Truths | a world that forgets |
| Relationships matter tactically | Bonds · relational costs · reputation Truths · social Fronts · Access/Leverage/Seams | social play becoming pure color or +1 bonuses |
| Drama is mechanical, not bait | Drive · Question · Bonds · compels · Edge | roleplay-for-XP |
| The interior is sovereign | Held Truths · interiority invariant | dice dictating feelings |
...
| Growth is positional | Truths · Bonds · reputation · access · Front resolution · gradual skills | advancement becoming only number inflation |
| One engine, no bloat | Mode rule · surface test · design restraint | subsystem growth |
| Design claims stay visible | claim-status labels · math/simulation/playtest notes | hand-waved authority about what the engine proves |
...
| **Relational** | strain a bond, favor, reputation, trust, obligation, social position, or future access |
...
The Ledger converts fictional advantage into mechanical permission or stakes. It is the main enforcement point for legible cause and effect: players should be able to see how a fictional advantage becomes a specific mechanical change.
...
A Truth is a persistent fact of the game world — world state, location, relationship, reputation, injury, debt, promise, resource, belief, faction state, condition, or status. Truths persist until changed by play and are not consumed by use. This is how accumulated position becomes power: alliances, secrets, favors, territory, access, status, reputation, and obligations become durable parts of the fiction.
...
The cost gates the proactive trigger: you cannot gain Edge by expression alone, only by paying for it. (See §24, expression invariant.)
...
Advancement is primarily **positional**. Characters become more powerful because they are better connected, better informed, better trusted, more feared, more resourced, or better placed inside the world. Mechanical growth exists, but it is deliberately gradual.
...
## 23. Design Claim Status

FABLE separates what the design **intends**, what the math **supports**, what simulation **suggests**, what reasoning **predicts**, and what table play **confirms**. Design notes, modules, and revisions should label claims using these statuses.

| Status | Meaning |
|---|---|
| **Math-checked** | follows from explicit probability, thresholds, caps, or curves |
| **Simulated** | tested through repeated model, spreadsheet, or scripted scenarios |
| **Reasoned** | inferred from the structure but not yet numerically or repeatedly tested |
| **Playtest-confirmed** | observed at tables with actual play pressure |
| **Open** | plausible but not yet established |

Current core claims:

| Claim | Status |
|---|---|
| 3d6 + Skill makes trained characters reliable relative to swingy flat dice | Math-checked |
| TN / Exposure / Effect separation prevents danger from being hidden inside difficulty | Reasoned |
| Preparation matters through Ledger payouts, Top Exit, and Truth creation | Reasoned |
| Complex obstacles preserve uncertainty unless the source of irreducibility is removed | Reasoned |
| No empty rolls keeps play focused on meaningful change | Reasoned |
| Relationships can function as tactical assets and liabilities through Truths, Bonds, relational costs, Access, Leverage, and Seams | Reasoned |
| Positional advancement can carry much of long-term growth without fast numerical inflation | Open until playtest-confirmed |
| The surface set is sufficient across all listed Modes without subsystem growth | Open until broad playtest-confirmed |

> **Claim discipline.** Do not state a design claim as proven unless its status supports that claim. The game applies the same standard to design that it applies to fiction: visible commitments, clear cause and effect, and no hidden hand-waving.
